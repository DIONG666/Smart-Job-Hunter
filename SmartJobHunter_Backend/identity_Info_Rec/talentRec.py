...
# 示例调用
# resumes_data_path = './identity_Info_Rec/Resumes.json'
# work_id = 63  # 假设的特定工作ID
# all_info_path = './identity_Info_Rec/all_info.json'
# city_location_path= './identity_Info_Rec/city_coordinates_cache.json'
