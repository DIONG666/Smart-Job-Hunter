        ...
        <>
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <Upload
                        drag
                        action={`http://127.0.0.1:5000/resume/upload/${user.user_id}`}
                        limit={1}
                        onExceedLimit={() => {
                ...
                <div style={{marginTop: 15}}>
                    <div style={{display: 'flex',alignItems:"center"}}>
                        ...
                        >
                            <p>
                                ...
                                <br/>
                                我们根据合法、正当、必要的原则，仅收集实现招聘目的所必要的信息。我们会按照如下方式收集您的个人信息，
                                包括但不限于您在使用我们的招聘服务时主动提供的、通过自动化手段收集的您在使用或接受服务中所产生的以及来自其他第三方的信息：
                                <br/>
                                ...
                                您作为申请的一部分向我们提供的信息。当您使用我们的门户网站申请职位时，您向我们提供的关于您的信息。这包括您在注册和使用门户网站时提供的简历信息
                                （如您的姓名、性别、
                                身份证号、联络信息、当前居住国家/地区、当前居住省/市（选填）、个人照片（选填）、紧急联系人信息（选填）、学历信息、工作经历、资料证明人信息（选填））以及您选择在门户网站提交或上传至门户网站的信息（如来自简历或附件中的信息）。
                                <br/>
                                <span style={{fontWeight: 'bolder'}}>岗位符合度评估</span><br/>
                                来自第三方的信息。我们可能会就您的申请从第三方接收信息，如推荐人、招聘人员、前用人单位或现用人单位及其雇员、
                                招聘服务机构及提供背景调查的组织（包括在适用法律允许的情况下，进行资料、资格核实等背景调查）。
                                <br/>
                                我们基于以下目的使用您的信息：<br/>
                                1.与您通信，沟通招聘事宜；<br/>
                                2.识别及评估您是否适合相关职位；<br/>
                                ...
                                我们不会转让您的个人信息给任何其他第三方，除非征得您的明确同意。随着我们业务的持续发展，我们有可能进行合并、收购、资产转让等交易。
                                如若发生我们将告知您相关情形，按照法律法规及不低于本政策所要求的标准继续保护或要求接收方继续保护您的个人信息，否则我们将要求该接收方重新征得您的同意。
                                <br/>
                                ...
                                一般情况下，我们会将境内收集的个人信息存储于中华人民共和国境内。
                                若您申请境外岗位时，可能需要将您的个人信息跨境传输或储存到岗位所在的国家或地区。
                                除此之外，我们不会跨境传输或存储您的个人信息。将来如需跨境传输或存储的，我们会向您告知个人信息出境的目的、接收方、安全保证措施和安全风险，
                                并征您的单独同意。此外根据国内法律、行政法规和相关监管部门的规定执行，通过签订协议、评估核查等有效措施，要求境外机构为所获得的您的个人信息保密。
                                <br/><br/>
                                ...
                                若发生个人信息泄露、损毁、丢失等安全事件，我们会启动应急预案，阻止安全事件扩大。安全事件发生后，我们会及时以推送通知、
                                邮件等形式向您告知安全事件的基本情况、我们即将或已经采取的处置措施和补救措施，以及我们对您的应对建议。
                                <br/><br/>
                    ...
                    <div style={{marginTop: 10}}>
                        <RadioGroup onChange={value=>{
                            axios({
                                method:'post',
                                url:'http://127.0.0.1:5000/resume/post-info/'+user.user_id,
                                data:{
                                    "identity":'student',
                    ...
                    <div style={{marginTop: 30, float: 'right'}}>
                        <Button onClick={() => {
                            navigate('/main/student_information/edit',{state:user})
                        }} style={{
                            color: 'white',
