...
const RecruitPage=()=>{
    ...
    useEffect(() => {
        axios({
            method:'get',
            url:'http://127.0.0.1:5000/talents/recommended/'+user.user_id,
        }).then(
            res=>{
                setPerson(res.data)
                setLoading(false)
                        ...
                        <div style={{width:'100%',backgroundColor:'white',height:'65px',display:'flex',alignItems:'center'}}>
                            ...
                            <div style={{marginLeft:'3%'}}>
                                <RadioGroup onChange={value => {
                                    axios({
                                        method:'get',
                                        url:`http://127.0.0.1:5000/talents/sort/${user.user_id}/${value}`,
                                    }).then(
                                        res=>{
                                            setPerson(res.data)
                                            setSelectedPerson({
                                        ...
                                        selectedPerson.id===-1?
                                            ...
                                            <Button
                                                onClick={()=>{
                                                    axios({
                                                        method:'get',
                                                        url:'http://127.0.0.1:5000/resumes/view/'+selectedPerson.id
                                                    }).then(
                                                        res=>{
